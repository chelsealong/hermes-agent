...
class TestWriteFileHandler:
    ...
    def test_writes_content(self, mock_get):
        ...
        # /tmp itself may be a symlink (e.g. to /private/tmp on macOS); the
        # handler forwards the realpath-resolved target, so compare against
        # that instead of the literal input path.
