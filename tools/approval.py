...
HARDLINE_PATTERNS = [
    ...
    # Filesystem format — anchored like the shutdown/reboot rules below so
    # `mkfs` inside quoted prose (`echo "does this use mkfs?"`) does not
    # false-positive; only `mkfs` at an actual command position fires.
