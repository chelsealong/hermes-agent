...
export const ru = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      convertLargePastesTitle: 'Преобразовывать большие вставки во вложения',
      convertLargePastesDesc:
        'Вставка большого блока текста становится вложением .txt вместо встроенного содержимого. Отключите, чтобы всегда вставлять как обычный текст.',
