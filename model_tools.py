...
def _emit_post_tool_call_hook(
    *, function_name: str, function_args: Dict[str, Any], result: Any,
    ...
    gateway_session_key: Optional[str] = None, duration_ms: int = 0,
...
def handle_function_call(
    ...
    api_request_id: Optional[str] = None, gateway_session_key: Optional[str] = None,
    user_task: Optional[str] = None, enabled_tools: Optional[List[str]] = None,
